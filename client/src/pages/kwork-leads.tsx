...
import { DEFAULT_OLLAMA_PORT, DEFAULT_OLLAMA_BASE_URL } from "@/lib/hosting-env";
...
export default function KworkLeadsPage() {
  ...
  useEffect(() => {
    ...
    apiRequest("POST", "/api/providers/check", { providerType: s.providerType || "ollama", baseUrl: s.baseUrl || DEFAULT_OLLAMA_BASE_URL, port: s.port || DEFAULT_OLLAMA_PORT })
      .then(r => r.json())
